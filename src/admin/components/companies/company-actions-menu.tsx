...
export const CompanyActionsMenu = ({ company, refetch }: { company: CompanyDTO; refetch: () => void }) => {
  const [editOpen, setEditOpen] = useState(false);
  const [deleteOpen, setDeleteOpen] = useState(false);
  const { mutate: mutateDelete, loading: loadingDelete } = useDeleteCompany(company.id);
  ...
  return (
    <>
      ...
      <CompanyUpdateDrawer company={company} refetch={refetch} open={editOpen} setOpen={setEditOpen} />
