import { Avatar, Badge, Container, Heading, Table, Toaster, Text } from '@medusajs/ui';
          ...
          <>
            ...
            <Table>
              <Table.Body>
                ...
                <Table.Row>
                  <Table.Cell className="font-medium font-sans txt-compact-small">State</Table.Cell>
        ...
        {!loading && (
          <>
            <div className="flex items-center gap-2 px-6 py-4 justify-between border-b border-gray-200">
              <div className="flex items-center gap-2">
                <Heading className="font-sans font-medium h1-core">Company Employees</Heading>
              </div>
                  ...
                  {company?.employees.map((employee: EmployeeDTO) => (
                    ...
                    >
                      ...
                      <Table.Cell onClick={(e) => e.stopPropagation()}>
                        <EmployeesActionsMenu company={company} employee={employee} refetch={refetch} />
                      </Table.Cell>
                    </Table.Row>
                  ))}
                </Table.Body>
