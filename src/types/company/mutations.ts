...
export interface CreateCompanyDTO extends Omit<Partial<CompanyDTO>, 'id' | 'createdAt' | 'updatedAt'> {}
...
export interface CreateEmployeeDTO extends Omit<Partial<EmployeeDTO>, 'id' | 'createdAt' | 'updatedAt'> {
  customer_id: string;
}
